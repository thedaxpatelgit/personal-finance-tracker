...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\pygments\styles\murphy.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pygments.styles.murphy.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pygments.styles.murphy.source.html#l24">
                  <tt><i>24</i>     </tt>
               </a>
            </li>
            </ul>
