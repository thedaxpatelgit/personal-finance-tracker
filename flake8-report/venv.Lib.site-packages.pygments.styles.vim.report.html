...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\pygments\styles\vim.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pygments.styles.vim.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pygments.styles.vim.source.html#l25">
                  <tt><i>25</i>     </tt>
               </a>
            </li>
            </ul>
