...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\pygments\styles\pastie.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pygments.styles.pastie.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pygments.styles.pastie.source.html#l27">
                  <tt><i>27</i>     </tt>
               </a>
            </li>
            </ul>
