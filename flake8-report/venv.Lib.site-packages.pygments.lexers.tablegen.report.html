...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\pygments\lexers\tablegen.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pygments.lexers.tablegen.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pygments.lexers.tablegen.source.html#l104">
                  <tt><i>104</i> <span class="k">class</span><span class="w"> </span><span class="nc">TableGenLexer</span><span class="p">(</span><span class="n">RegexLexer</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>
