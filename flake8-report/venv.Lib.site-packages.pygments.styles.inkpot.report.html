...
<html>
   <head>
      <title>flake8 violations: venv\Lib\site-packages\pygments\styles\inkpot.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pygments.styles.inkpot.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pygments.styles.inkpot.source.html#l21">
                  <tt><i>21</i>     </tt>
               </a>
            </li>
            </ul>
